...
print("--- Searching for Consórcio products ---")
res = get_data("products?select=id,name,category_id&name=ilike.*Consórcio*&organization_id=eq.5111af72-27a5-41fd-8ed9-8c51b78b4fdd")
print(res)
