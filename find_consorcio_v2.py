...
print("--- Searching for Consórcio category ---")
# Using URL encoding for special characters if needed
res = get_data("product_categories?select=id,name")
if isinstance(res, list):
    found = [c for c in res if "Consórcio" in c['name'] or "CONSORCIO" in c['name'].upper()]
