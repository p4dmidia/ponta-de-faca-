...
data = {}
data["recent_orders"] = query("orders", "select=id,status,user_id,organization_id,created_at&status=eq.Pago&order=created_at.desc&limit=10")

with open("orders_debug_output.json", "w") as f:
