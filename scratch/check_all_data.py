...
print("--- RECENT AFFILIATES (Last 10, All Orgs) ---")
affs = query_table("affiliates", "order=created_at.desc&limit=10")
print(json.dumps(affs, indent=2))

print("\n--- RECENT USERS (Last 10, All Orgs) ---")
users = query_table("user_profiles", "order=created_at.desc&limit=10")
